...
sayHelloButton.addEventListener('mouseover', addStyles)
...
sayHelloButton.addEventListener('mouseout', defaultStyles)
// PROBLEM 4
/*
...
const repeatMyParam = () => {
    //YOUR CODE HERE
    axios.get('http://localhost:3000/repeat/cheetahs')
    .then(res=> {
...
// CODE HERE
const myFunction = () => {
    axios.get('http://localhost:3000/query-test/?q=bears')
    .then(res=> console.log(res.data))
    .catch(err=>console.log(err))
}

document.querySelector('#query-button').addEventListener('click', myFunction)
...
// const myFunction = () => {
//     axios.get('http://localhost:3000/query-test/?q=lions&q=tigers')
//     .then(res=> console.log(res.data))
//     .catch(err=>console.log(err))
// }
...
document.querySelector('form').style.margin = '30px';
